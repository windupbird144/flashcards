  ...
  return (
    <>
      ...
      {!card ? (
        ...
        <PageStudyCard card={card} onJudge={judge} />
      )}
    </>
  );
}

function PageStudyCard(props: { card: Card; onJudge: (e: Event) => void }) {
  ...
  return (
    <>
      {props.card === null && (
        <p>"There are no cards to study at this time.";</p>
      )}

      <div class="card">
        <div className="card-front">{props.card?.front}</div>
        {hidden ? (
          <div class="card-cover" onClick={reveal}>
            Click to reveal
          </div>
        ) : (
          <div class="card-back">
            ...
            <div className="buttons" onClick={props.onJudge}>
              <button type="submit" data-value="yes">
                yes
              </button>
              <button type="submit" data-value="no">
                no
              </button>
            </div>
          </div>
...
function PageBrowse() {
  ...
  return (
    <>
      <h3>Browse</h3>
      <p hidden={!!cards.length}>You have not created any cards.</p>
